...
class Report_warehouse_mu extends CI_Controller{
    
    function __construct(){
		parent::__construct();
		$this->load->model('m_report_warehouse_mu','',TRUE);
    ...
    function index(){
        foreach($this->m_report_warehouse_mu->revenue()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_mu->target()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_mu->ebitda()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_mu->target_ebitda()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_mu->cost()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_mu->target_cost()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_mu->cost_revenue()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_mu->target_cost_revenue()->result_array() as $row){
        ...
        $this->template->display('graphic/report_warehouse_mu',$data);
	}
}
