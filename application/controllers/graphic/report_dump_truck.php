...
class Report_dump_truck extends CI_Controller{
    
    function __construct(){
		parent::__construct();
		$this->load->model('m_report_dump_truck','',TRUE);
    ...
    function index(){
        foreach($this->m_report_dump_truck->revenue()->result_array() as $row){
		...
		foreach($this->m_report_dump_truck->target()->result_array() as $row){
		...
		foreach($this->m_report_dump_truck->ebitda()->result_array() as $row){
		...
		foreach($this->m_report_dump_truck->target_ebitda()->result_array() as $row){
		...
		foreach($this->m_report_dump_truck->cost()->result_array() as $row){
		...
		foreach($this->m_report_dump_truck->target_cost()->result_array() as $row){
		...
		foreach($this->m_report_dump_truck->cost_revenue()->result_array() as $row){
		...
		foreach($this->m_report_dump_truck->target_cost_revenue()->result_array() as $row){
        ...
        $this->template->display('graphic/report_dump_truck',$data);
	}
}
