...
class Report_packaging_latinusa extends CI_Controller{
    
    function __construct(){
		parent::__construct();
		$this->load->model('m_report_packaging_latinusa','',TRUE);
    ...
    function index(){
        foreach($this->m_report_packaging_latinusa->revenue()->result_array() as $row){
		...
		foreach($this->m_report_packaging_latinusa->target()->result_array() as $row){
		...
		foreach($this->m_report_packaging_latinusa->ebitda()->result_array() as $row){
		...
		foreach($this->m_report_packaging_latinusa->target_ebitda()->result_array() as $row){
		...
		foreach($this->m_report_packaging_latinusa->cost()->result_array() as $row){
		...
		foreach($this->m_report_packaging_latinusa->target_cost()->result_array() as $row){
		...
		foreach($this->m_report_packaging_latinusa->cost_revenue()->result_array() as $row){
		...
		foreach($this->m_report_packaging_latinusa->target_cost_revenue()->result_array() as $row){
        ...
        $this->template->display('graphic/report_packaging_latinusa',$data);
	}
}
