...
class Report_packaging_crm extends CI_Controller{
    
    function __construct(){
		parent::__construct();
		$this->load->model('m_report_packaging_crm','',TRUE);
    ...
    function index(){
        foreach($this->m_report_packaging_crm->revenue()->result_array() as $row){
		...
		foreach($this->m_report_packaging_crm->target()->result_array() as $row){
		...
		foreach($this->m_report_packaging_crm->ebitda()->result_array() as $row){
		...
		foreach($this->m_report_packaging_crm->target_ebitda()->result_array() as $row){
		...
		foreach($this->m_report_packaging_crm->cost()->result_array() as $row){
		...
		foreach($this->m_report_packaging_crm->target_cost()->result_array() as $row){
		...
		foreach($this->m_report_packaging_crm->cost_revenue()->result_array() as $row){
		...
		foreach($this->m_report_packaging_crm->target_cost_revenue()->result_array() as $row){
        ...
        $this->template->display('graphic/report_packaging_crm',$data);
	}
}
