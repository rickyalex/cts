...
class Report_warehouse_holcim extends CI_Controller{
    
    function __construct(){
		parent::__construct();
		$this->load->model('m_report_warehouse_holcim','',TRUE);
    ...
    function index(){
        foreach($this->m_report_warehouse_holcim->revenue()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_holcim->target()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_holcim->ebitda()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_holcim->target_ebitda()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_holcim->cost()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_holcim->target_cost()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_holcim->cost_revenue()->result_array() as $row){
		...
		foreach($this->m_report_warehouse_holcim->target_cost_revenue()->result_array() as $row){
        ...
        $this->template->display('graphic/report_warehouse_holcim',$data);
	}
}
