...
class Report_packaging_posco extends CI_Controller{
    
    function __construct(){
		parent::__construct();
		$this->load->model('m_report_packaging_posco','',TRUE);
    ...
    function index(){
        foreach($this->m_report_packaging_posco->revenue()->result_array() as $row){
		...
		foreach($this->m_report_packaging_posco->target()->result_array() as $row){
		...
		foreach($this->m_report_packaging_posco->ebitda()->result_array() as $row){
		...
		foreach($this->m_report_packaging_posco->target_ebitda()->result_array() as $row){
		...
		foreach($this->m_report_packaging_posco->cost()->result_array() as $row){
		...
		foreach($this->m_report_packaging_posco->target_cost()->result_array() as $row){
		...
		foreach($this->m_report_packaging_posco->cost_revenue()->result_array() as $row){
		...
		foreach($this->m_report_packaging_posco->target_cost_revenue()->result_array() as $row){
        ...
        $this->template->display('graphic/report_packaging_posco',$data);
	}
}
