...
class Report_cilegon extends CI_Controller{
    
    function __construct(){
		parent::__construct();
		$this->load->model('m_report_cilegon','',TRUE);
    ...
    function index(){
        foreach($this->m_report_cilegon->revenue()->result_array() as $row){
		...
		foreach($this->m_report_cilegon->target()->result_array() as $row){
		...
		foreach($this->m_report_cilegon->ebitda()->result_array() as $row){
		...
		foreach($this->m_report_cilegon->target_ebitda()->result_array() as $row){
		...
		foreach($this->m_report_cilegon->cost()->result_array() as $row){
		...
		foreach($this->m_report_cilegon->target_cost()->result_array() as $row){
		...
		foreach($this->m_report_cilegon->cost_revenue()->result_array() as $row){
		...
		foreach($this->m_report_cilegon->target_cost_revenue()->result_array() as $row){
        ...
        $this->template->display('graphic/report_cilegon',$data);
	}
}
