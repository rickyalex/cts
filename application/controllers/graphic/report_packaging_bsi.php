...
class Report_packaging_bsi extends CI_Controller{
    
    function __construct(){
		parent::__construct();
		$this->load->model('m_report_packaging_bsi','',TRUE);
    ...
    function index(){
        foreach($this->m_report_packaging_bsi->revenue()->result_array() as $row){
		...
		foreach($this->m_report_packaging_bsi->target()->result_array() as $row){
		...
		foreach($this->m_report_packaging_bsi->ebitda()->result_array() as $row){
		...
		foreach($this->m_report_packaging_bsi->target_ebitda()->result_array() as $row){
		...
		foreach($this->m_report_packaging_bsi->cost()->result_array() as $row){
		...
		foreach($this->m_report_packaging_bsi->target_cost()->result_array() as $row){
		...
		foreach($this->m_report_packaging_bsi->cost_revenue()->result_array() as $row){
		...
		foreach($this->m_report_packaging_bsi->target_cost_revenue()->result_array() as $row){
        ...
        $this->template->display('graphic/report_packaging_bsi',$data);
	}
}
