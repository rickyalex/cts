...
class Report_transport_cilacap extends CI_Controller{
    
    function __construct(){
		parent::__construct();
		$this->load->model('m_report_transport_cilacap','',TRUE);
    ...
    function index(){
        foreach($this->m_report_transport_cilacap->revenue()->result_array() as $row){
		...
		foreach($this->m_report_transport_cilacap->target()->result_array() as $row){
		...
		foreach($this->m_report_transport_cilacap->ebitda()->result_array() as $row){
		...
		foreach($this->m_report_transport_cilacap->target_ebitda()->result_array() as $row){
		...
		foreach($this->m_report_transport_cilacap->cost()->result_array() as $row){
		...
		foreach($this->m_report_transport_cilacap->target_cost()->result_array() as $row){
		...
		foreach($this->m_report_transport_cilacap->cost_revenue()->result_array() as $row){
		...
		foreach($this->m_report_transport_cilacap->target_cost_revenue()->result_array() as $row){
