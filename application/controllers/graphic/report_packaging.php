...
class Report_packaging extends CI_Controller{
    
    function __construct(){
		parent::__construct();
		$this->load->model('m_report_packaging','',TRUE);
    ...
    function index(){
        foreach($this->m_report_packaging->revenue()->result_array() as $row){
		...
		foreach($this->m_report_packaging->target()->result_array() as $row){
		...
		foreach($this->m_report_packaging->ebitda()->result_array() as $row){
		...
		foreach($this->m_report_packaging->target_ebitda()->result_array() as $row){
		...
		foreach($this->m_report_packaging->cost()->result_array() as $row){
		...
		foreach($this->m_report_packaging->target_cost()->result_array() as $row){
		...
		foreach($this->m_report_packaging->cost_revenue()->result_array() as $row){
		...
		foreach($this->m_report_packaging->target_cost_revenue()->result_array() as $row){
        ...
        $this->template->display('graphic/report_packaging',$data);
	}
}
