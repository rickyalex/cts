...
<script>
	$(document).ready(function(){
		...
		$('button').click(function(e){
			...
			var from = $( "#from" ).val();
			var to = $( "#to" ).val();
			window.open("<?php echo base_url(); ?>view_detail/viewRitage/from/"+from+"/to/"+to,'_parent');
		});
						...
						<div style="padding:10px;border:1px solid #ccc">
							<div class="row">
								<div class="col-xs-2 col-sm-2 col-md-2">
									<i class="fa fa-road" style="font-size:32px;margin-top:10px"></i>
								</div>
				...
				<div class="xcrud-list-container">
					<table class="table table-bordered table-hover table-responsive">
						<thead class="portlet box green-haze">
							<tr><td width="5%"><b>No</b></td><td><b>No DO</b></td><td><b>No Unit</b></td><td><b>Tgl Transaksi</b></td><td><b>Ritage</b></td></tr>
						</thead>
						<tbody>
