...
class cts_model extends Ci_Model{
 ...
 function getStatus()
 {
	...
	foreach($arr as $key => $item){
		if($arr[$key]['status'] == "on train") $ontrain++;
		elseif($arr[$key]['status'] == "on depo") $ondepo++;
		elseif($arr[$key]['status'] == "load") $load++;
		elseif($arr[$key]['status'] == "unload") $unload++;
	}
 ...
 function getLastPosition()
 {
	...
	foreach($arr as $key => $item){
		if($arr[$key]['last_position'] == "CDP") if($arr[$key]['status'] == "ON DEPO" || $arr[$key]['status'] == "CLOSED") $cdp++;
		elseif($arr[$key]['last_position'] == "SBY") $sby++;
		elseif($arr[$key]['last_position'] == "CLG") $clg++;
	}
