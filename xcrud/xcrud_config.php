...
{
    // default connection
    public static $dbname = 'master'; // Your database name
    public static $dbuser = 'root'; // Your database username
    public static $dbpass = 'c1l3g0nbcs321'; // // Your database password
    public static $dbhost = '10.2.2.32'; // Your database host, 'localhost' is default.
